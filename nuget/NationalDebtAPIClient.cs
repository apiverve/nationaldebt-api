...
namespace APIVerve.API.NationalDebt
{
    ...
    /// <summary>
    /// Client for the NationalDebt API
    /// </summary>
    public class NationalDebtAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/nationaldebt";
        ...
        public NationalDebtAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public NationalDebtAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public NationalDebtAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, NationalDebtQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(NationalDebtQueryOptions options)
        {
        ...
        public ResponseObj Execute(NationalDebtQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(NationalDebtQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(NationalDebtQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(NationalDebtQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(NationalDebtQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(NationalDebtQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(NationalDebtQueryOptions options)
        {
