// Package nationaldebt provides a Go client for the National Debt API.
//
// For more information, visit: https://apiverve.com/marketplace/nationaldebt?utm_source=go&utm_medium=readme
package nationaldebt
...
// Request contains the parameters for the National Debt API.
//
// Parameters:
//   - date: string - Optional date in YYYY-MM-DD format for historical lookup. Omit for current data. [format: date]
type Request struct {
...
// ResponseData contains the data returned by the National Debt API.
type ResponseData struct {
	Date string `json:"date"`
	TotalDebt float64 `json:"totalDebt"`
	TotalDebtFormatted string `json:"totalDebtFormatted"`
	PublicDebt float64 `json:"publicDebt"`
	PublicDebtFormatted string `json:"publicDebtFormatted"`
	IntragovernmentalDebt float64 `json:"intragovernmentalDebt"`
	IntragovernmentalDebtFormatted string `json:"intragovernmentalDebtFormatted"`
	PerCapita int `json:"perCapita"`
	PerCapitaFormatted string `json:"perCapitaFormatted"`
