...
const (
	baseURL        = "https://api.apiverve.com/v1/nationaldebt"
	defaultTimeout = 30 * time.Second
)

// Client is the National Debt API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new National Debt API client.
...
// Execute makes a request to the National Debt API with typed parameters.
//
