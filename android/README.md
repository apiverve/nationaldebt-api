...
```gradle
dependencies {
    implementation 'com.github.apiverve:nationaldebt-api:1.1.13'
}
```
...
```java
import com.apiverve.nationaldebt.NationalDebtAPIClient;
import com.apiverve.nationaldebt.APIResponse;
import com.apiverve.nationaldebt.APIException;

// Initialize the client
NationalDebtAPIClient client = new NationalDebtAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/nationaldebt](https://docs.apiverve.com/ref/nationaldebt)
...
- **Documentation:** [https://docs.apiverve.com/ref/nationaldebt](https://docs.apiverve.com/ref/nationaldebt)
- **Issues:** [GitHub Issues](https://github.com/apiverve/nationaldebt-api/issues)
